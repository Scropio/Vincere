...
public class DeviceControlActivity extends Activity {
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            ...
            if (!mBluetoothLeService.initialize()) {
                Log.e("JK_", "Unable to initialize Bluetooth");
                finish();
            }
                ...
                public boolean onChildClick(ExpandableListView parent, View v, int groupPosition,
                    ...
                    if (mGattCharacteristics != null) {
                        ...
                        if ((charaProp & BluetoothGattCharacteristic.PROPERTY_READ) > 0) {
                            ...
                            Log.d("JK_","BluetoothGattCharacteristic has PROPERTY_READ, so send read request");
                        ...
                        if ((charaProp & BluetoothGattCharacteristic.PROPERTY_NOTIFY) > 0) {
                            Log.d("JK_","BluetoothGattCharacteristic has PROPERTY_NOTIFY, so send notify request");
                        ...
                        if (((charaProp & BluetoothGattCharacteristic.PROPERTY_WRITE) |
                            ...
                            Log.d("JK_","BluetoothGattCharacteristic has PROPERY_WRITE | PROPERTY_WRITE_NO_RESPONSE");
    ...
    protected void onResume() {
        ...
        if (mBluetoothLeService != null) {
            ...
            Log.d("JK_","Connect request result=" + result);
        }
    }
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            ok.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (strBytes == null) {
                        Log.w("JK_","Cannot get Value from EditText Widget");
                        dismiss();
                        return;
                    }
                    ...
                    if (bytes == null) {
                        ...
                        Log.w("JK_","Cannot get Values from mWriteCharacteristic.");
                        dismiss();
                        return;
