...
public class BluetoothLeService extends Service {
    ...
    private void startReadRssi() {
        if (mHandler.hasMessages(READ_RSSI_REPEAT)) {
            Log.w("JK_","+++++++++ Handler already has Message: READ_RSSI_REPEAT");
        }
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            Log.d("JK_","onConnectionStateChange status = " + status + ", newState = " + newState);
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                Log.d("JK_","Connected to GATT server.");
                // Attempts to discover services after successful connection.
                Log.d("JK_","Attempting to start service discovery:" +
                ...
                stopReadRssi();
                Log.d("JK_","Disconnected from GATT server.");
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            Log.d("JK_","onServicesDiscovered status = " + status);
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                Log.d("JK_","onServicesDiscovered received: " + status);
            }
        }
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
                                         ...
                                         int status) {
            Log.d("JK_","onCharacteristicRead status: " + status);
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt,
                                          BluetoothGattCharacteristic characteristic,
                                          int status) {
            Log.d("JK_","------------- onCharacteristicWrite status: " + status);
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
                                            BluetoothGattCharacteristic characteristic) {
            Log.d("JK_","onCharacteristicChanged");
    ...
    private void displayCharacteristic(final BluetoothGattCharacteristic characteristic) {
        ...
        if (UUID_HEART_RATE_MEASUREMENT.equals(characteristic.getUuid())) {
            ...
            if ((flag & 0x01) != 0) {
                ...
                Log.d("JK_","Heart rate format UINT16.");
            } else {
                format = BluetoothGattCharacteristic.FORMAT_UINT8;
                Log.d("JK_","Heart rate format UINT8.");
            }
            final int heartRate = characteristic.getIntValue(format, 1);
            Log.d("JK_",String.format("Received heart rate: %d", heartRate));
    ...
    public boolean initialize() {
        ...
        if (mBluetoothManager == null) {
            ...
            if (mBluetoothManager == null) {
                Log.e("JK_","Unable to initialize BluetoothManager.");
                return false;
            }
        }
        ...
        if (mBluetoothAdapter == null) {
            Log.e("JK_","Unable to obtain a BluetoothAdapter.");
            return false;
        }
    ...
    public boolean connect(final String address) {
        if (mBluetoothAdapter == null || address == null) {
            Log.w("JK_","BluetoothAdapter not initialized or unspecified address.");
            return false;
        }
        ...
        if (mBluetoothDeviceAddress != null && address.equals(mBluetoothDeviceAddress)
                && mBluetoothGatt != null) {
            Log.d("JK_","Trying to use an existing mBluetoothGatt for connection.");
        ...
        if (device == null) {
            Log.w("JK_","Device not found.  Unable to connect.");
            return false;
        }
        // We want to directly connect to the device, so we are setting the autoConnect
        // parameter to false.
        mBluetoothGatt = device.connectGatt(this, false, mGattCallback);
        Log.d("JK_","Trying to create a new connection.");
    ...
    public void disconnect() {
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            Log.w("JK_","BluetoothAdapter not initialized");
            return;
        }
